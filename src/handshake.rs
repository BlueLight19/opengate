...
pub const CAPABILITY_MULTIPATH_BIT: u32 = 1 << 0;
pub const CAPABILITY_RESUME_BIT: u32 = 1 << 1;
pub const CAPABILITY_PERIODIC_HYBRID_REKEY_BIT: u32 = 1 << 2;
pub const CAPABILITY_ECN_BIT: u32 = 1 << 3;
pub const KNOWN_CAPABILITY_BITS: u32 = CAPABILITY_MULTIPATH_BIT
    | CAPABILITY_RESUME_BIT
    | CAPABILITY_PERIODIC_HYBRID_REKEY_BIT
    | CAPABILITY_ECN_BIT;

...
| Entropy failure | Fallible operating-system entropy calls, terminal handshake failure, temporary-buffer zeroization | Compromised OS RNG or hidden backend copy |
